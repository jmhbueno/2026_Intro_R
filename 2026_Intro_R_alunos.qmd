...
Note que, ao criar uma variável como "renda total", com um espaço entre as palavras, o R põe um ponto entre as palavras, e a variável fica denominada "renda.total".
O mesmo ocorre no nome da variável "estado civil".
...
unique(df$estado_civil) # mostra as categorias existentes dentro de uma variável
...
# obs: na maioria das vezes, funções da família tidyverse não necessitam de aspas no nome das variáveis.
...
Agora, é necessário importar o arquivo `imdb1001.rds` para dentro do R, salvando-o como imdb1000.
...
# criar um objeto com a url onde do arquivo
link_vr <- "https://raw.githubusercontent.com/jmhbueno/2026_Intro_R/main/Variables.xlsx"
...
[Clique aqui](https://docs.google.com/spreadsheets/d/1w3q0IaghY282XE2mLUDKtCoFCYao2SrIemikMVYuNQg/edit?usp=sharing) e faça o download do arquivo `big_five.xlsx` para a pasta de trabalho que você está usando para esta disciplina.

Esse é um banco de dados estrangeiro, está codificado no sistema europeu.

Use a função `read_excel()` do pacote `readxl` para importá-lo e salve-o como um objeto do R (dataframe) chamado `big_five`.
...
Baixe o dataframe [aqui](https://docs.google.com/spreadsheets/d/1KxEdCQvl2t11SQLlA-65usQB1W_UnWX2PGXqVi-O87w/edit?usp=sharing), importe-o para dentro do RStudio e use as funções do tidyverse para resolver os próximos exercícios.
