...
No entanto, se você quiser usar o leitor de PDF Adobe Reader, é necessário instalá-lo.
...
pacman::p_load(readr,readxl,haven,tidyverse,knitr,psych,expss)
```
...
nrow(df)
view(df)
file.choose() # abre uma janela para procurar o arquivo desejado e retorna o caminho.
